$(function () {
    ...
    module("bootstrap-carousel-touch")

      test("should provide no conflict", function () {
        var carousel_touch = $.fn.carousel_touch.noConflict()
        ok(!$.fn.carousel_touch, 'carousel touch was set back to undefined (org value)')
        $.fn.carousel_touch = carousel_touch
      })

      test("should be defined on jquery object", function () {
        ok($(document.body).carousel_touch, 'carousel method is defined')
      })
      ...
      test("should not fire sliden when slide is prevented", function () {
        ...
        stop()
        $('<div class="carousel carousel_touch"/>')
