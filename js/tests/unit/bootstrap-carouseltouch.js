$(function () {
    ...
    module("bootstrap-carouseltouch")
      ...
      test("should provide no conflict", function () {
        var carouseltouch = $.fn.carouseltouch.noConflict()
        ok(!$.fn.carouseltouch, 'carouseltouch touch was set back to undefined (org value)')
        $.fn.carouseltouch = carouseltouch
      })

      test("should be defined on jquery object", function () {
        ok($(document.body).carouseltouch, 'carouseltouch method is defined')
      })

      test("should return element", function () {
        ok($(document.body).carouseltouch()[0] == document.body, 'document.body returned')
      })
